                    ...
                    <div className="row">
                        <div className="col-md-4 mb-5">
                            ...
                            <div className="d-flex flex-column justify-content-start">
                                ...
                                <Link className="text-dark mb-2" to="/"><i className="fa fa-angle-right mr-2"></i>Shop Detail</Link>
                                <Link className="text-dark mb-2" to="/"><i className="fa fa-angle-right mr-2"></i>Shopping Cart</Link>
                                <Link className="text-dark mb-2" to="/"><i className="fa fa-angle-right mr-2"></i>Checkout</Link>
            ...
            <div className="row border-top border-light mx-xl-5 py-4">
                <div className="col-md-6 px-xl-0">
                    <p className="mb-md-0 text-center text-md-left text-dark">
                        &copy; <Link className="text-dark font-weight-semi-bold" to="/">E-Shopper</Link>. All Rights Reserved. Designed
                        by &nbsp;
                        <Link className="text-dark font-weight-semi-bold" to="/">Durvash Nimje</Link>
                    </p>
                </div>
                <div className="col-md-6 px-xl-0 text-center text-md-right">
                    <img className="img-fluid" src={image_url+"payments.png"} alt="Payment" />
                </div>
            </div>
        </div>
    )
